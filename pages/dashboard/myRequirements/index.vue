<template>
  <div class="workarea-container">
    ...
    <div class="intro-container">
      ...
      <br />
      <p>Below data shows the various requirements of medical institutions, like medicines, equipments, hospital-furniture etc. You can browse through each of them so se what fits your supply capability.Click on any row you desire to the requirement list. You can download the list for keeping an offline copy.</p>
